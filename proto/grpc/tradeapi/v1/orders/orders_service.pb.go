...
const file_grpc_tradeapi_v1_orders_orders_service_proto_rawDesc = "" +
	"\n" +
	",grpc/tradeapi/v1/orders/orders_service.proto\x12\x17grpc.tradeapi.v1.orders\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x19google/type/decimal.proto\x1a\x1bgrpc/tradeapi/v1/side.proto\x1a\x1cgrpc/tradeapi/v1/trade.proto\"\xd2\x02\n" +
	...
	"\x1bVALID_BEFORE_GOOD_TILL_DATE\x10\x032\xf8\x03\n" +
	"\rOrdersService\x12S\n" +
	"\n" +
	"PlaceOrder\x12\x1e.grpc.tradeapi.v1.orders.Order\x1a#.grpc.tradeapi.v1.orders.OrderState\"\x00\x12a\n" +
	"\vCancelOrder\x12+.grpc.tradeapi.v1.orders.CancelOrderRequest\x1a#.grpc.tradeapi.v1.orders.OrderState\"\x00\x12^\n" +
	"\tGetOrders\x12&.grpc.tradeapi.v1.orders.OrdersRequest\x1a'.grpc.tradeapi.v1.orders.OrdersResponse\"\x00\x12[\n" +
	"\bGetOrder\x12(.grpc.tradeapi.v1.orders.GetOrderRequest\x1a#.grpc.tradeapi.v1.orders.OrderState\"\x00\x12r\n" +
	"\x13SubscribeOrderTrade\x12*.grpc.tradeapi.v1.orders.OrderTradeRequest\x1a+.grpc.tradeapi.v1.orders.OrderTradeResponse(\x010\x01B%P\x01Z!MCP/proto/grpc/tradeapi/v1/ordersb\x06proto3"
