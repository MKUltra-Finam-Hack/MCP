...
const file_grpc_tradeapi_v1_marketdata_marketdata_service_proto_rawDesc = "" +
	"\n" +
	"4grpc/tradeapi/v1/marketdata/marketdata_service.proto\x12\x1bgrpc.tradeapi.v1.marketdata\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x19google/type/decimal.proto\x1a\x1agoogle/type/interval.proto\x1a\x1bgrpc/tradeapi/v1/side.proto\"\x9e\x01\n" +
	...
	"\rTIME_FRAME_QR\x10\x162\xd1\a\n" +
	"\x11MarketDataService\x12]\n" +
	"\x04Bars\x12(.grpc.tradeapi.v1.marketdata.BarsRequest\x1a).grpc.tradeapi.v1.marketdata.BarsResponse\"\x00\x12d\n" +
	"\tLastQuote\x12).grpc.tradeapi.v1.marketdata.QuoteRequest\x1a*.grpc.tradeapi.v1.marketdata.QuoteResponse\"\x00\x12l\n" +
	"\tOrderBook\x12-.grpc.tradeapi.v1.marketdata.OrderBookRequest\x1a..grpc.tradeapi.v1.marketdata.OrderBookResponse\"\x00\x12u\n" +
	"\fLatestTrades\x120.grpc.tradeapi.v1.marketdata.LatestTradesRequest\x1a1.grpc.tradeapi.v1.marketdata.LatestTradesResponse\"\x00\x12{\n" +
	...
	"\rSubscribeBars\x121.grpc.tradeapi.v1.marketdata.SubscribeBarsRequest\x1a2.grpc.tradeapi.v1.marketdata.SubscribeBarsResponse0\x01B)P\x01Z%MCP/proto/grpc/tradeapi/v1/marketdatab\x06proto3"
